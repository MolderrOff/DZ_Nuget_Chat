...
namespace ChatProject
{
    public class Server
    {
        private readonly Dictionary<String, string> clients = new Dictionary<String, string>(); //было [] вместо new Dictionary<String, string>()
        ...
        public void Work()
        {
            ...
            while (work)
            {
                try
                {
                    Console.WriteLine("Сервер заведён");
